...
public class BriqueCyan extends Brique {
	...
	public BriqueCyan(char lettre, int point) {
		// TODO Auto-generated constructor stub
		super(Forme.CYAN, lettre,point);
	...
	public void configuredroite(){
		...
		this.droite[0][0]=false;
		this.droite[0][1]=false;
		this.droite[0][2]=false;
	...
	public void configuregauche(){
		...
		this.gauche[0][0]=false;
		this.gauche[0][1]=false;
		this.gauche[0][2]=false;
		this.gauche[0][3]=false;


		this.gauche[1][0]=false;
		this.gauche[1][1]=true;
		this.gauche[1][2]=false;
		this.gauche[1][3]=false;

		this.gauche[2][0]=false;
		this.gauche[2][1]=true;
		this.gauche[2][2]=true;
		this.gauche[2][3]=true;
