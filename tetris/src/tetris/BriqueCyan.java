...
public class BriqueCyan extends Brique {

	public BriqueCyan( Map<Integer,Cellule> cellules) {
		// TODO Auto-generated constructor stub
		super(Forme.CYAN, cellules);
		//this.setForme(Forme.CYAN);
	...
	public void configurehaut(){
		...
		this.haut[1][0]=null;
		this.haut[1][1]=null;
		this.haut[1][2]=cellules.get(1);
		this.haut[1][3]=null;

		this.haut[2][0]=null;
		this.haut[2][1]=cellules.get(2);
		this.haut[2][2]=cellules.get(3);
		this.haut[2][3]=null;
	...
	public void configuredroite(){
		...
		this.droite[1][1]=cellules.get(0);
		this.droite[1][2]=cellules.get(1);
		this.droite[1][3]=cellules.get(2);
	...
	public void configurebas(){
		...
		this.bas[0][0]=null;
		this.bas[0][1]=cellules.get(0);
		this.bas[0][2]=cellules.get(1);
		this.bas[0][3]=null;
	...
	public void configuregauche(){
		...
		this.gauche[1][1]=cellules.get(0);
		this.gauche[1][2]=null;
		this.gauche[1][3]=null;

		this.gauche[2][0]=null;
		this.gauche[2][1]=cellules.get(1);
		this.gauche[2][2]=cellules.get(2);
